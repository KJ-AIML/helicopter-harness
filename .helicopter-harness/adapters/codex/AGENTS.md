...
Codex must treat `.helicopter-harness/HARNESS.md` as the source of truth.
...
5. Read repo-local `AGENTS.md`, `CLAUDE.md`, `README*`, package/build/test files, and other relevant docs.
