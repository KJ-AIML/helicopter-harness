...
The skill makes that rule callable as its own capability, instead of being one paragraph inside `yo-fix-loop` Phase 0 that only fires on multi-finding waves.
