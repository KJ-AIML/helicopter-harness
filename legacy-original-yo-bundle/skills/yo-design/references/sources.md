...
- **Sunk-cost dynamics in review** — by PR time reviewers polish the chosen approach rather than question it; moving approach review earlier is the only structural fix. This is the same author-framing bias the pack's yo-audit cites (reviewers rate identical work differently given the author's framing).
