...
- **Semantic Versioning + Hyrum's Law** (shared with yo-release) — majors signal intent to break, but minors can break you anyway via observed behavior; hence "green build ≠ safe upgrade."
