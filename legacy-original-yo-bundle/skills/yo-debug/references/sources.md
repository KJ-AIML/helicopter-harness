...
- The pack's own small-commit discipline (yo-branch unit mapping) is what makes bisect's answer actionable — a Google-CL-guide-sized commit is readable; a mega-commit is not.
